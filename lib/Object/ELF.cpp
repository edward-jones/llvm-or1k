...
StringRef getELFRelocationTypeName(uint32_t Machine, uint32_t Type) {
  ...
  case ELF::EM_OPENRISC:
    switch (Type) {
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_NONE);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_8);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_LO_16_IN_INSN);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_HI_16_IN_INSN);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_INSN_REL_26);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GNU_VTENTRY);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GNU_VTINHERIT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_32_PCREL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_16_PCREL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_8_PCREL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GOTPC_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GOTPC_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GOT16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_PLT26);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GOTOFF_HI16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GOTOFF_LO16);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_COPY);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_GLOB_DAT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_JMP_SLOT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_OR1K_RELATIVE);
    }
    break;
  default:
    break;
