...
StringRef OR1KMCExpr::getVariantKindName(OR1KMCExpr::VariantKind VK) {
  switch (VK) {
  default: return "";
  case VK_OR1K_ABS_HI16: return "hi";
  case VK_OR1K_ABS_LO16: return "lo";
  case VK_OR1K_PLT26: return "plt";
  case VK_OR1K_GOT16: return "got";
  case VK_OR1K_GOTPC_HI16: return "gotpchi";
  case VK_OR1K_GOTPC_LO16: return "gotpclo";
  case VK_OR1K_GOTOFF_HI16: return "gotoffhi";
  case VK_OR1K_GOTOFF_LO16: return "gotofflo";
  }
}
...
void OR1KMCExpr::PrintImpl(raw_ostream &OS) const {
  bool NeedParens = isVariantKindExplicit(Variant) ||
                    isa<MCBinaryExpr>(Expr);
...
bool OR1KMCExpr::
EvaluateAsRelocatableImpl(MCValue &Res, const MCAsmLayout *Layout) const {
...
void OR1KMCExpr::AddValueSymbols(MCAssembler *Asm) const {
